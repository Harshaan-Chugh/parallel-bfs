...
\author{Aakaash Nattanmai\thanks{Equal contribution.}\\Cornell University \and Harshaan Chugh\footnotemark[1]\\Cornell University}
\date{May 13, 2026\\[0.35em]\small Repository: \url{https://github.com/Harshaan-Chugh/parallel-bfs}}
...
Aakaash focused on GPU benchmarking,
multi-GPU evaluation, and integrating the GPU and multi-GPU results into the
final analysis. Harshaan focused on linear algebraic approaches to the single GPU CUDA implementation, the MPI extension, and distributed-memory analysis. Both members contributed to
CUDA BFS implementation, validation, poster preparation, SNAP road-network
...
Experiments were run on NERSC Perlmutter. We would further like to thank
Professor Guidi for providing ample resources and slides to teach us foundation
